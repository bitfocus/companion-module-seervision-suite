...
export default class Api {
	...
	constructor(dopIp: string, pathPrefix: string, useLegacyUrl: boolean, onUpdate: () => void, logger: Logger) {
		this.#connection = new Connection(dopIp, pathPrefix, useLegacyUrl, logger)
